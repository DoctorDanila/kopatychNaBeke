...
{
    public $modelClass = \app\modules\v1\models\Readers::class;
...
//        unset($actions['delete']);
    ...
    {
        $model = \app\modules\v1\models\Readers::findOne($id);

        if (!$model) {
            throw new NotFoundHttpException("Reader with id $id not found");
        }
